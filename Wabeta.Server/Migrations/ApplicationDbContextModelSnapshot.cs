...
namespace WAbeta.Server.Migrations
{
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WAbeta.Server.Models.CurrentWeather", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WAbeta.Server.Models.FiveDaysWeather", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("WAbeta.Server.Models.Item", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("WAbeta.Server.Models.Record", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("WAbeta.Server.Models.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("WAbeta.Server.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("WAbeta.Server.Models.CurrentWeather", b =>
                {
                    b.HasOne("WAbeta.Server.Models.Tenant", "Tenant")
            ...
            modelBuilder.Entity("WAbeta.Server.Models.Item", b =>
                {
                    b.HasOne("WAbeta.Server.Models.FiveDaysWeather", "FiveDaysWeather")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("WAbeta.Server.Models.Record", b =>
                {
                    b.HasOne("WAbeta.Server.Models.CurrentWeather", "CurrentWeather")
                        .WithMany()
